...
if len(sys.argv) == 2: # just start/stop
  subprocess.call([cmdpath+"pvw.py","auto.py","htr.autotune.run.W",sys.argv[1]], shell=True)
if len(sys.argv) == 3: # start with parameters
  subprocess.call([cmdpath+"pvw.py","auto.py","htr.autotune.zone.W",sys.argv[1]], shell=True)
  subprocess.call([cmdpath+"pvw.py","auto.py","htr.autotune.setp.W",sys.argv[2]],shell=True)
