...
""".format(*fieldlist))
		...
		pfmts = ['r', 'k']
		zone1 = [20,7,9,5]	#a5, a6, b6, b8
		zone2 = [2,6]		#a2, b5
		zone4 = [13,18,12,18]	#b1, b2, b10, b11
		zone5 = [10,4,3,11,8,17]	#a3, a4, b9, b13, b7
		zone6 = [1,0,15,14]	#a0, a1, b3
		zone_marg = [16,22,23,24,25,26,27,28,29]
		QE = [21]
