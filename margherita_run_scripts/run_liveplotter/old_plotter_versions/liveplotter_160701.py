...
def main():
		...
		tail_tempfile = '/local/data2/margherita/data/liveplotter_data/temprun0.txt'
		#label data loading
...
""".format(*fieldlist))
		...
		threeHourInterval = timedelta(hours=24)
	...
	#	tlabels = ['a0','a1','a2','a3','a4','a5','a6','b5','b6','b7','b8','b9','b13','pump','b1','b2','b3','m1','b10','b11','m2','m3','m4','m5','m6','m7','m8','m9']
		...
		savefig('/local/data2/margherita/data/liveplotter_data/plots_0701_history.png',bbox_inches='tight')
		close()
