...
def readEnabledZones():
	process = subprocess.Popen([usrFile + '/rtczn.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE )
...
if __name__ == '__main__':
	...
	snapshotfile = "/local/data2/margherita/data/control_data/snapshots.txt" 	#file to save each change in the setpoint configuration
	templogfile = "/local/data2/margherita/data/control_data/controlrun0.txt" #file to log control TC's into
